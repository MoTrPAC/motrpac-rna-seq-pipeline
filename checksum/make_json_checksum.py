...
#  f=open(file_path,"w")
  my_list = [line.strip("\n") for line in open(i)]
  d= {"checksum_workflow.checksum.num_preempt": "0","checksum_workflow.checksum.memory": "20","checksum_workflow.checksum.disk_space": "30","checksum_workflow.checksum.num_threads": "4","checksum_workflow.checksum.docker": "gcr.io/motrpac-portal/motrpac_rnaseq:v0.1_04_20_19","checksum_workflow.sample_files":my_list}
  simplejson.dump(d, f)
  f.close()
