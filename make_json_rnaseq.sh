...
#fastq_dir="gs://motrpac-portal-transfer-stanford/montgomery/rat_pilot/RNA-seq/fastq"
#fastq_dir="gs://user-mshruti/rat/rat_pilot_data"
#fastq_dir="gs://archanaraja/rnaseq/test_data/pilot_stanford_NIH"
fastq_dir="gs://archanaraja/rnaseq/harmony_test/fastq_raw"
json_dir="input_json/harmony_test/stanford/"
mkdir -p ${json_dir}
...
indiv=$(gsutil ls ${fastq_dir}/*.fastq.gz|awk -F "/" '{print $7}'|awk -F "_" '{print $1}'|cut -f1|sort|uniq)
for i in $indiv; do
    ...
    echo "    \"rnaseq_pipeline.fastqi1\": \"${fastq_dir}/${i}${SUF_I1}\"," >> ${json_file}
...
#    echo >> ${json_file}
    ...
    echo "    \"rnaseq_pipeline.rnaqc.ref_flat\" : \"${rn6_refFlat}\"," >> ${json_file}
