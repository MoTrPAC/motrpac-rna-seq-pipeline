...
parser.add_argument('--estimate_rspd', type=str.lower, choices=['true', 'false'], default='false', help='Set to estimate the read start position distribution from data (recommended)')
...
parser.add_argument('--seed', type=str.lower, choices=['true', 'false'], default='false', help='Set the seed for the random number generators used in calculating posterior mean estimates and credibility intervals')
