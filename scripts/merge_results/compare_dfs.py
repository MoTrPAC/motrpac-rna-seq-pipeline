...
tpm_bic = pd.read_csv(
    "/Users/archanaraja/work/repo/motrpac-rna-seq-pipeline/pass1a_results/Stanford/Nicole/bic/rsem_genes_tpm_pass1a_batch1_Stanford.tab.csv",
    sep="\t", header=0
    )
...
counts_bic = pd.read_csv(
    "/Users/archanaraja/work/repo/motrpac-rna-seq-pipeline/pass1a_results/Stanford/Nicole/bic/rsem_genes_count_pass1a_batch1_Stanford.tab.csv",
    sep="\t", header=0
    )
