...
#fs.ls('***REMOVED***-transfer-stanford/rna-seq/rat/batch1_20190503/fastq_raw')
#l1=fs.glob('***REMOVED***-transfer-stanford/rna-seq/rat/batch1_20190503/fastq_raw/*_R1.fastq.gz')
