...
gcloud beta compute --project=***REMOVED*** instances create ubuntu1904-nopreempt-rnaseq-n1-standard-8 \
  --zone=us-west1-b \
...
gcloud beta ssh --zone=us-west1-b ubuntu1904-nopreempt-rnaseq-n1-standard-8 --project=***REMOVED***
#INSTALL DOCKER
