#Usage example : python3 scripts/make_json_rnaseq.py motrpac-portal-transfer-stanford/rna-seq/rat/batch4_20200106/ input_json/test3/ 4
...
def main(gcp_path,output_path,num_chunks):
  ...
  batch_num=1
  gcp_path=gcp_path+"fastq_raw/*_R1.fastq.gz"
  ...
  split_r1=[[sub.replace('motrpac-portal', 'gs://motrpac-portal') for sub in l] for l in split_r1]
